...
// Create a function, runInOrder that accepts: an array of functions, an array of numbers
function runInOrder(arrFuncs, arrTime) {
  // execute the functions in order, with corresponding numbers in milliseconds being the time to wait from the previous invocation
  let time = 0;
  arrFuncs.forEach((element, index) => {
    time += arrTime[index];
